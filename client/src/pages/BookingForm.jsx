...
const BookingForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      >
        <h2 className="text-2xl font-bold mb-5 text-center">Confirm Booking</h2>
        ...
        {service && (
          <div className="mb-4 p-3 bg-gray-100 rounded">
            <p className="font-medium">Service: {service.service.name}</p>
            <p className="text-green-600">Price: ₹{service.price}</p>
          </div>
        )}
        ...
        <button onClick={() => setSelectedTime("3:00 PM")}>3:00 PM</button>
