...
const Services = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.name.trim() || !form.category || !form.serviceMode) {
      alert("Name, category and service mode are required");
    ...
    try {
      if (editingId) {
        ...
        await API.put(`/service/${editingId}`, form);

        alert("Service updated successfully");
      } else {
        // CREATE

        await API.post("/service/create", form);
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">
            Create and manage services offered on Easy Book.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b">
            <h3 className="text-xl font-bold text-gray-800">All Services</h3>
                  ...
                  {services.map((service) => (
                    <tr key={service._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <img
                          src={
                            service.image || "https://via.placeholder.com/80"
                          }
                          alt={service.name}
